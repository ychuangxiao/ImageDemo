...
public class RedPacketsDetailIosFragment extends BaseFragmentDaggerActivity {
    ...
    public RedPacketsDetailIosFragment() {
    ...
    public static RedPacketsDetailIosFragment newInstance(RedPackedDetailsModel redPackedDetailsModel,
                                                          BottomNavigationView
                                                                  bottomNavigationView) {
        RedPacketsDetailIosFragment fragment = new RedPacketsDetailIosFragment();
    ...
    protected int getContentViewId() {
        return R.layout.fragment_details_red_packets_ios;
    }
