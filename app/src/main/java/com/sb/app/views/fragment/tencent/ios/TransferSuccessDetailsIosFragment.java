...
public class TransferSuccessDetailsIosFragment extends BaseFragmentDaggerActivity {
    ...
    public TransferSuccessDetailsIosFragment() {
    ...
    public static TransferSuccessDetailsIosFragment newInstance(RedPackedDetailsModel redPackedDetailsModel,
                                                                BottomNavigationView
                                                                     bottomNavigationView) {
        TransferSuccessDetailsIosFragment fragment = new TransferSuccessDetailsIosFragment();
