 ...
 * 修改备注：
 */
public class PocketMoneyFragment extends BaseFragment implements ContactClickListener<Double> {
     ...
     */
    public static PocketMoneyFragment newInstance(BottomNavigationView
                                                          bottomNavigationView) {
        PocketMoneyFragment fragment = new PocketMoneyFragment();
