 ...
 * 修改备注：
 */
public class ChatFriendTransferItemView extends RelativeLayout {
     ...
     * @return
     */
    public static ChatFriendTransferItemView build(Context context) {
        ChatFriendTransferItemView instance = new ChatFriendTransferItemView(context);
        instance.onFinishInflate();
        return instance;
    }

    public ChatFriendTransferItemView(Context context) {
        super(context);
        mContext = context;
    }
