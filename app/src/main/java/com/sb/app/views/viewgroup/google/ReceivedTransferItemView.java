 ...
 * 修改备注：
 */
public class ReceivedTransferItemView extends RelativeLayout {
     ...
     * @return
     */
    public static ReceivedTransferItemView build(Context context) {
        ReceivedTransferItemView instance = new ReceivedTransferItemView(context);
        instance.onFinishInflate();
        return instance;
    }

    public ReceivedTransferItemView(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void onFinishInflate() {
        if (!alreadyInflated) {
            ...
            inflate(getContext(), R.layout.row_received_transfer_we_chat, this);
