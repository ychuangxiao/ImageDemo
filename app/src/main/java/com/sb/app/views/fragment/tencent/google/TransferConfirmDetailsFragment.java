...
public class TransferConfirmDetailsFragment extends BaseFragmentDaggerActivity {
    ...
    public TransferConfirmDetailsFragment() {
    ...
    public static TransferConfirmDetailsFragment newInstance(RedPackedDetailsModel redPackedDetailsModel,
                                                             BottomNavigationView
                                                                     bottomNavigationView) {
        TransferConfirmDetailsFragment fragment = new TransferConfirmDetailsFragment();
