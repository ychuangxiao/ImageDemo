    ...
    public static OkHttpClient.Builder createOkHttpClient(final AppEntity appEntity, boolean onFailure) {
        ...
        httpClient.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request request = chain.request().newBuilder().header(TextConstant.HEADER_NAME_ONE, appEntity.getAppVersion().toString()).header
                        (TextConstant.HEADER_ACCEPT, TextConstant.HEADER_APPLICATION_JSON_VALUE).header(TextConstant.HEADER_CONTENT_TYPE,
