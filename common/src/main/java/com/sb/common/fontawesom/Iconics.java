package com.sb.common.fontawesom;
...
import com.sb.common.fontawesom.typeface.ITypeface;
import com.sb.common.fontawesom.utils.IconicsTypefaceSpan;
...
/**
 * Created by banditcat on 15/4/26 16:25.
 * com.sb.fontawesom.iconics
 */
public class Iconics {
    ...
    static {
        BaseFontAwesome fa = new BaseFontAwesome();
    ...
    private static SpannableString style(Context ctx, HashMap<String, ITypeface> fonts, StringBuilder text, List<CharacterStyle> styles, HashMap<String, List<CharacterStyle>> stylesFor) {
        ...
        while ((startIndex = text.indexOf("{", startIndex + 1)) != -1) {
            ...
            if (!text.substring(startIndex + 5, startIndex + 6).equals("-")) {
                break;
            }
            //get the fontKey
            fontKey = text.substring(startIndex + 1, startIndex + 5);
